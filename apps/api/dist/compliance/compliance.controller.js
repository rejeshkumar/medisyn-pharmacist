...
let ComplianceController = class ComplianceController {
    ...
    getLog(req, from, to, doctorName, medicine, scheduleClass) {
    ...
    async exportLog(req, from, to, res) {
        const buffer = await this.complianceService.exportToExcel(req.tenantId, { from, to }, req.user);
...
__decorate([
    ...
    __param(3, (0, common_1.Query)('doctor_name')),
    __param(4, (0, common_1.Query)('medicine')),
    __param(5, (0, common_1.Query)('schedule_class')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Export Schedule Drug Register to Excel (Owner only)' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Query)('from')),
    __param(2, (0, common_1.Query)('to')),
