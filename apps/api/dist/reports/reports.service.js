...
let ReportsService = class ReportsService {
    ...
    async getPeriodSales(tenantId, from, to) {
    ...
    async getTopMedicines(tenantId, from, to) {
    ...
    async getNearExpiryReport(tenantId, days = 90) {
    ...
    async getStockValuation(tenantId) {
    ...
    async exportSalesToExcel(tenantId, from, to) {
