...
let StockController = class StockController {
    ...
    getStockList(req, search, expiryDays, lowStock, scheduleClass, supplierId, molecule, category) {
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('expiry_days')),
    __param(3, (0, common_1.Query)('low_stock')),
    __param(4, (0, common_1.Query)('schedule_class')),
    __param(5, (0, common_1.Query)('supplier_id')),
    __param(6, (0, common_1.Query)('molecule')),
    __param(7, (0, common_1.Query)('category')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, Number, Boolean, String, String, String, String]),
