...
export default function OwnerFinancialDashboard() {
  ...
  const [activeSection, setActiveSection] = useState<'dashboard'|'purchases'|'upcoming'>('dashboard');
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="flex gap-1 bg-gray-100 rounded-xl p-1 mb-6">
        {([
          ...
          { key: 'purchases' as const, label: '🏪 Pharmacy Purchases' },
          { key: 'upcoming' as const, label: '📅 Upcoming Payments' },
        ]).map(s => (
