    ...
    <div className="flex h-full overflow-hidden bg-slate-50">
      ...
      <div className={`${showSidebar ? 'flex' : 'hidden'} md:flex w-56 flex-shrink-0 bg-white border-r border-slate-100 flex-col overflow-hidden absolute md:relative z-20 h-full`}>
        ...
        <div className="flex-1 overflow-y-auto py-2">
          ...
          {/* ── Inventory Classification (separate page) ── */}
          <div className="mb-3 mt-2 pt-2 border-t border-slate-100">
            <div className="flex items-center gap-1.5 px-4 py-1">
              <BarChart3 className="w-3 h-3 text-indigo-600" />
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Inventory</span>
            </div>
            <a href="/reports/inventory-classification"
              className="w-full block text-left px-4 py-2 text-xs text-slate-600 hover:bg-slate-50 transition-colors">
