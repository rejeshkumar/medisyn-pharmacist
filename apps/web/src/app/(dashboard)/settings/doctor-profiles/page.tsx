        ...
        <div className="p-5 space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="sm:col-span-2">
              ...
              <textarea value={clinicForm.clinic_address}
                ...
                placeholder="SimpliRx Speciality Clinic, Taliparamba, Kannur, Kerala - 670141" />
            </div>
            <div>
          ...
          <div className="bg-gray-50 border rounded-lg p-4 mt-2">
            ...
            <div className="text-center py-2 border-b-2 border-[#00475a]">
              <div className="text-base font-extrabold text-[#00475a] tracking-wide">{clinic?.name || 'SimpliRx Speciality Clinic'}</div>
