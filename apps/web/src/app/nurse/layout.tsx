      ...
      <aside className={cn(
        ...
        <div className="p-5 border-b border-white/10 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/60">Nurse Station</p>
          </div>
          <button className="ml-auto lg:hidden text-white/60 hover:text-white" onClick={() => setSidebarOpen(false)}><X className="w-5 h-5" /></button>
        </div>
          ...
          {navItems.map(item => {
            ...
            return (
              <Link key={item.href} href={item.href} onClick={() => setSidebarOpen(false)}
                className={cn('flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-[13px] font-semibold transition-all',
        ...
        <div className="p-3 border-t border-white/10">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg mb-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-white/60 capitalize">Nurse</p>
            </div>
          </div>
          <button onClick={handleLogout}
            className="flex items-center gap-2 w-full px-3 py-2 text-sm text-white/80 hover:text-white hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
