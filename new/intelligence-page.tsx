// apps/web/app/(dashboard)/inventory/intelligence/page.tsx
'use client';
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-3">
          ...
          >
            {refreshing ? '🔄 Refreshing...' : '🔄 Refresh All Velocities'}
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="border-b border-gray-200">
          <nav className="flex space-x-8 px-6">
            ...
            >
              ⚠️ Stockout Risk ({(summary?.stockout_risk.critical || 0) + (summary?.stockout_risk.high || 0) + (summary?.stockout_risk.medium || 0)})
            </button>
            <button
            ...
            >
              🚀 Fast Moving ({summary?.fast_moving.count || 0})
            </button>
            <button
            ...
            >
              🐌 Slow Moving ({summary?.slow_moving.count || 0})
            </button>
            <button
            ...
            >
              💀 Dead Stock ({summary?.dead_stock.count || 0})
            </button>
          </nav>
        </div>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead>
                  <tr>
                    ...
                    {activeTab === 'stockout' && (
                      <>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Avg Sales/Day</th>
